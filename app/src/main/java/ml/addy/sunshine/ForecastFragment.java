...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // Use the class name as the log tag
        ...
        private String getReadableDateString(long time){
            ...
            // (3 letter weekday, 3 letter month, 2 digit date)
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                // Get the JSON object representing the current day
        ...
        protected String[] doInBackground(String... params) {
            ...
            String format = "json";
            String units = "metric";
            int numDays = 7; // Number of forecast days
         ...
         *
         * @param forecastResults the String array returned from doInBackground()
         */
