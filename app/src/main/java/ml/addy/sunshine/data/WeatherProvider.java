...
public class WeatherProvider extends ContentProvider {
    ...
    static {
        ...
        // setTables fills out the FROM part of the SQL query
    ...
    // Define the selections (uses the ? replacement syntax)
    // The selection parameters replace the ?'s
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case WEATHER_WITH_LOCATION_AND_DATE:
                // ITEM type because only one row is returned
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;
            case WEATHER_WITH_LOCATION:
                // The rest are DIR type because more than one row is returned
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // Register the cursor with a Content Observer to watch for changes that happen to
        // that URI or any of its descendants. Lets the Content Provider to tell the UI
        // when the cursor changes (like on a database update or insert)
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        // Notify all of the registered Content Observers -- using passed in URI, not returned URI
